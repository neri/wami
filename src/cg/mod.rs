    ...
    pub fn generate(
        ...
        loop {
            ...
            macro_rules! MEM_LOAD {
                ($val_type:ident, $mnemonic:ident, $opcode:ident, $module:ident, $stream:ident, $position:ident, $int_codes:ident, $value_stack:ident,) => {
                    #[cfg(test)]
                    ...
                    $int_codes.push(WasmImc::new(
                        WasmIntMnemonic::$mnemonic(arg.offset, ExceptionPosition::new($position)),
            ...
            macro_rules! BIN_DIV {
                ($val_type:ident, $mnemonic:ident, $opcode:ident, $position:ident, $int_codes:ident, $value_stack:ident,) => {
                    ...
                    $int_codes.push(WasmImc::new(
                        WasmIntMnemonic::$mnemonic(ExceptionPosition::new($position)),
                        StackLevel($value_stack.len() - 1),
                    ));
                };
            }
            ...
            match opcode {
                WasmOpcode::Single(opcode) => match opcode {
                    ...
                    WasmSingleOpcode::Call => {
                        ...
                        int_codes.push(WasmImc::new(
                            WasmIntMnemonic::Call(func_index, ExceptionPosition::new(position)),
                            value_stack.len().into(),
                        ));
                        // TODO: type check
                    ...
                    WasmSingleOpcode::LocalGet => {
                        ...
                        int_codes.push(WasmImc::new(
                            WasmIntMnemonic::LocalGetI(LocalVarIndex(local_ref)),
                            value_stack.len().into(),
                        ));
                    ...
                    WasmSingleOpcode::LocalSet => {
                        ...
                        int_codes.push(WasmImc::new(
                            WasmIntMnemonic::LocalSetI(LocalVarIndex(local_ref)),
                            value_stack.len().into(),
                        ));
                    }
                    WasmSingleOpcode::LocalTee => {
                        ...
                        int_codes.push(WasmImc::new(
                            WasmIntMnemonic::LocalTeeI(LocalVarIndex(local_ref)),
                            StackLevel(value_stack.len() - 1),
                        ));
                    }
                    ...
                    WasmSingleOpcode::I32Load => {
                        #[rustfmt::skip]
                        MEM_LOAD!(I32, I32Load, opcode, module, stream, position, int_codes, value_stack, );
                    }
                    WasmSingleOpcode::I32Load8S => {
                        #[rustfmt::skip]
                        MEM_LOAD!(I32, I32Load8S, opcode, module, stream, position, int_codes, value_stack, );
                    }
                    WasmSingleOpcode::I32Load8U => {
                        #[rustfmt::skip]
                        MEM_LOAD!(I32, I32Load8U, opcode, module, stream, position, int_codes, value_stack, );
                    }
                    WasmSingleOpcode::I32Load16S => {
                        #[rustfmt::skip]
                        MEM_LOAD!(I32, I32Load16S, opcode, module, stream, position, int_codes, value_stack, );
                    }
                    WasmSingleOpcode::I32Load16U => {
                        #[rustfmt::skip]
                        MEM_LOAD!(I32, I32Load16U, opcode, module, stream, position, int_codes, value_stack, );
                    }

                    WasmSingleOpcode::I64Load => {
                        #[rustfmt::skip]
                        MEM_LOAD!(I64, I64Load, opcode, module, stream, position, int_codes, value_stack, );
                    }
                    WasmSingleOpcode::I64Load8S => {
                        #[rustfmt::skip]
                        MEM_LOAD!(I64, I64Load8S, opcode, module, stream, position, int_codes, value_stack, );
                    }
                    WasmSingleOpcode::I64Load8U => {
                        #[rustfmt::skip]
                        MEM_LOAD!(I64, I64Load8U, opcode, module, stream, position, int_codes, value_stack, );
                    }
                    WasmSingleOpcode::I64Load16S => {
                        #[rustfmt::skip]
                        MEM_LOAD!(I64, I64Load16S, opcode, module, stream, position, int_codes, value_stack, );
                    }
                    WasmSingleOpcode::I64Load16U => {
                        #[rustfmt::skip]
                        MEM_LOAD!(I64, I64Load16U, opcode, module, stream, position, int_codes, value_stack, );
                    }
                    WasmSingleOpcode::I64Load32S => {
                        #[rustfmt::skip]
                        MEM_LOAD!(I64, I64Load32S, opcode, module, stream, position, int_codes, value_stack, );
                    }
                    WasmSingleOpcode::I64Load32U => {
                        #[rustfmt::skip]
                        MEM_LOAD!(I64, I64Load32U, opcode, module, stream, position, int_codes, value_stack, );
                    }

                    WasmSingleOpcode::I32Store => {
                        #[rustfmt::skip]
                        MEM_STORE!(I32, I32Store, opcode, module, stream, position, int_codes, value_stack, );
                    }
                    WasmSingleOpcode::I32Store8 => {
                        #[rustfmt::skip]
                        MEM_STORE!(I32, I32Store8, opcode, module, stream, position, int_codes, value_stack, );
                    }
                    WasmSingleOpcode::I32Store16 => {
                        #[rustfmt::skip]
                        MEM_STORE!(I32, I32Store16, opcode, module, stream, position, int_codes, value_stack, );
                    }
                    WasmSingleOpcode::I64Store => {
                        #[rustfmt::skip]
                        MEM_STORE!(I64, I64Store, opcode, module, stream, position, int_codes, value_stack, );
                    }
                    WasmSingleOpcode::I64Store8 => {
                        #[rustfmt::skip]
                        MEM_STORE!(I64, I64Store8, opcode, module, stream, position, int_codes, value_stack, );
                    }
                    WasmSingleOpcode::I64Store16 => {
                        #[rustfmt::skip]
                        MEM_STORE!(I64, I64Store16, opcode, module, stream, position, int_codes, value_stack, );
                    }
                    WasmSingleOpcode::I64Store32 => {
                        #[rustfmt::skip]
                        MEM_STORE!(I64, I64Store32, opcode, module, stream, position, int_codes, value_stack, );
                    }

                    #[cfg(feature = "float")]
                    WasmSingleOpcode::F32Load => {
                        #[rustfmt::skip]
                        MEM_LOAD!(F32, F32Load, opcode, module, stream, position, int_codes, value_stack, );
                    }
                    #[cfg(feature = "float")]
                    WasmSingleOpcode::F64Load => {
                        #[rustfmt::skip]
                        MEM_LOAD!(F64, F64Load, opcode, module, stream, position, int_codes, value_stack, );
                    }
                    #[cfg(feature = "float")]
                    WasmSingleOpcode::F32Store => {
                        #[rustfmt::skip]
                        MEM_STORE!(F32, F32Store, opcode, module, stream, position, int_codes, value_stack, );
                    }
                    #[cfg(feature = "float")]
                    WasmSingleOpcode::F64Store => {
                        #[rustfmt::skip]
                        MEM_STORE!(F64, I64Store, opcode, module, stream, position, int_codes, value_stack, );
                    }
                    ...
                    WasmSingleOpcode::I32Eq => {
                        #[rustfmt::skip]
                        BIN_BR!(I32, I32Eq, opcode, position, int_codes, value_stack,);
                    }
                    WasmSingleOpcode::I32Ne => {
                        #[rustfmt::skip]
                        BIN_BR!(I32, I32Ne, opcode, position, int_codes, value_stack,);
                    }
                    WasmSingleOpcode::I32LtS => {
                        #[rustfmt::skip]
                        BIN_BR!(I32, I32LtS, opcode, position, int_codes, value_stack,);
                    }
                    WasmSingleOpcode::I32LtU => {
                        #[rustfmt::skip]
                        BIN_BR!(I32, I32LtU, opcode, position, int_codes, value_stack,);
                    }
                    WasmSingleOpcode::I32GtS => {
                        #[rustfmt::skip]
                        BIN_BR!(I32, I32GtS, opcode, position, int_codes, value_stack,);
                    }
                    WasmSingleOpcode::I32GtU => {
                        #[rustfmt::skip]
                        BIN_BR!(I32, I32GtU, opcode, position, int_codes, value_stack,);
                    }
                    WasmSingleOpcode::I32LeS => {
                        #[rustfmt::skip]
                        BIN_BR!(I32, I32LeS, opcode, position, int_codes, value_stack,);
                    }
                    WasmSingleOpcode::I32LeU => {
                        #[rustfmt::skip]
                        BIN_BR!(I32, I32LeU, opcode, position, int_codes, value_stack,);
                    }
                    WasmSingleOpcode::I32GeS => {
                        #[rustfmt::skip]
                        BIN_BR!(I32, I32GeS, opcode, position, int_codes, value_stack,);
                    }
                    WasmSingleOpcode::I32GeU => {
                        #[rustfmt::skip]
                        BIN_BR!(I32, I32GeU, opcode, position, int_codes, value_stack,);
                    }
                    ...
                    WasmSingleOpcode::I64Eq => {
                        #[rustfmt::skip]
                        BIN_BR!(I64, I64Eq, opcode, position, int_codes, value_stack,);
                    }
                    WasmSingleOpcode::I64Ne => {
                        #[rustfmt::skip]
                        BIN_BR!(I64, I64Ne, opcode, position, int_codes, value_stack,);
                    }
                    WasmSingleOpcode::I64LtS => {
                        #[rustfmt::skip]
                        BIN_BR!(I64, I64LtS, opcode, position, int_codes, value_stack,);
                    }
                    WasmSingleOpcode::I64LtU => {
                        #[rustfmt::skip]
                        BIN_BR!(I64, I64LtU, opcode, position, int_codes, value_stack,);
                    }
                    WasmSingleOpcode::I64GtS => {
                        #[rustfmt::skip]
                        BIN_BR!(I64, I64GtS, opcode, position, int_codes, value_stack,);
                    }
                    WasmSingleOpcode::I64GtU => {
                        #[rustfmt::skip]
                        BIN_BR!(I64, I64GtU, opcode, position, int_codes, value_stack,);
                    }
                    WasmSingleOpcode::I64LeS => {
                        #[rustfmt::skip]
                        BIN_BR!(I64, I64LeS, opcode, position, int_codes, value_stack,);
                    }
                    WasmSingleOpcode::I64LeU => {
                        #[rustfmt::skip]
                        BIN_BR!(I64, I64LeU, opcode, position, int_codes, value_stack,);
                    }
                    WasmSingleOpcode::I64GeS => {
                        #[rustfmt::skip]
                        BIN_BR!(I64, I64GeS, opcode, position, int_codes, value_stack,);
                    }
                    WasmSingleOpcode::I64GeU => {
                        #[rustfmt::skip]
                        BIN_BR!(I64, I64GeU, opcode, position, int_codes, value_stack,);
                    }
                ...
                WasmOpcode::PrefixFC(opcode) => match opcode {
                    WasmOpcodeFC::MemoryCopy => {
                        ...
                        int_codes.push(WasmImc::new(
                            WasmIntMnemonic::MemoryCopy(ExceptionPosition::new(position)),
                            value_stack.len().into(),
                        ));
                    }
                    ...
                    WasmOpcodeFC::MemoryFill => {
                        ...
                        int_codes.push(WasmImc::new(
                            WasmIntMnemonic::MemoryFill(ExceptionPosition::new(position)),
                            value_stack.len().into(),
                        ));
                    }
        ...
        if int_codes.len() > 2 {
            ...
            for i in 0..limit {
                ...
                match (this_op, next_op) {
                    ...
                    (I32Const(val), I32And) => {
                        fused2!(int_codes, i, FusedI32AndI(*val));
                    }
                    (I32Const(val), I32Or) => {
                        fused2!(int_codes, i, FusedI32OrI(*val));
                    }
                    (I32Const(val), I32Xor) => {
                        fused2!(int_codes, i, FusedI32XorI(*val));
                    }
                    (I32Const(val), I32Shl) => {
                        fused2!(int_codes, i, FusedI32ShlI(*val));
                    }
                    (I32Const(val), I32ShrS) => {
                        fused2!(int_codes, i, FusedI32ShrSI(*val));
                    }
                    (I32Const(val), I32ShrU) => {
                        fused2!(int_codes, i, FusedI32ShrUI(*val));
                    }
